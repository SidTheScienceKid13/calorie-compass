...
const macros = [
  { label: "Calories", before: "900", after: "290", unit: "cal", width: "32%", delay: "0ms" },
  { label: "Protein", before: "55g", after: "22g", unit: "left", width: "40%", delay: "100ms" },
  { label: "Carbs", before: "85g", after: "36g", unit: "left", width: "42%", delay: "200ms" },
  { label: "Fat", before: "30g", after: "3g", unit: "left", width: "10%", delay: "300ms" },
];
    ...
    <div className="relative">
      ...
      <section className="relative rounded-3xl border border-white/10 bg-zinc-900 p-6 shadow-2xl shadow-black/40">
        <div className="flex items-start justify-between gap-4 border-b border-white/10 pb-5">
          <div>
            <p className="text-sm text-zinc-400">Example macro fit</p>
        ...
        <p className="mt-6 rounded-xl border border-orange-500/20 bg-orange-500/10 px-4 py-3 text-sm text-orange-100">
          A sample recommendation that fits these remaining targets.
        </p>
      </section>
    </div>
  );
